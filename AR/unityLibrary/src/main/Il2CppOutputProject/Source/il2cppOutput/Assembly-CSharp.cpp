...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void GrabbableMobile_MoveObject_m0EEA42243C0539A24C3EC699C779D4149A39432E (GrabbableMobile_tE7B7E9099617EFAA88478E0CB433E8F221E0DF4E* __this, Vector2_t1FD6F485C871E832B347AB2DC8CBA08B739D8DF7 ___0_touchPos, const RuntimeMethod* method) 
{
	...
	memset((&V_1), 0, sizeof(V_1));
	{
		...
		NullCheck(L_0);
		bool L_3;
		L_3 = ARRaycastManager_Raycast_mF56A1E2D7CBB61131E4D844ADA9D0CC1F6B53EAC(L_0, L_1, L_2, ((int32_t)15), NULL);
		if (!L_3)
		{
			goto IL_006d;
		}
...
IL_01a0:
	{
		__this->___isStretching = (bool)0;
		__this->___isRotating = (bool)0;
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_64 = V_5;
		NullCheck(L_64);
		Rigidbody_set_isKinematic_m6C3FD3EA358DADA3B191F2449CF1C4F8B22695ED(L_64, (bool)0, NULL);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_65 = V_2;
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF** L_66 = (Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF**)(&__this->___activeRotationRenderer);
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_67 = __this->___highlightColor;
		GrabbableMobile_HighlightRenderer_mC1437A516901709E2275474DAF90D9E243FD4B04(__this, L_65, L_66, L_67, NULL);
		return;
	}
...
IL_01ca:
	{
		...
		NullCheck(L_68);
		bool L_69;
		L_69 = GameObject_CompareTag_m6378BE50D009A93D46036F74CC3F7E2ECB0636E5(L_68, _stringLiteral37B25D3AA58F7F804FCD98D2B9F3536CEF8DCD49, NULL);
		if (L_69)
		{
			goto IL_023b;
		}
	}
	{
		...
		L_71 = GameObject_GetComponent_TisRigidbody_t268697F5A994213ED97393309870968BC1C7393C_m2D7F86C77ECF9B82AAC077B511F1004280571B90(L_70, GameObject_GetComponent_TisRigidbody_t268697F5A994213ED97393309870968BC1C7393C_m2D7F86C77ECF9B82AAC077B511F1004280571B90_RuntimeMethod_var);
		V_6 = L_71;
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_72 = V_6;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_73;
	...
	}
	{
		...
		__this->___grabbedObject = L_74;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___grabbedObject), (void*)L_74);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_75 = __this->___grabbedObject;
		NullCheck(L_75);
		...
		L_78 = RaycastHit_get_point_m02B764612562AFE0F998CC7CFB2EEDE41BA47F39((&V_1), NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_79;
		L_79 = Vector3_op_Subtraction_mE42023FF80067CB44A1D4A27EB7CF2B24CABB828_inline(L_77, L_78, NULL);
		__this->___grabOffset = L_79;
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_80 = V_6;
		NullCheck(L_80);
		Rigidbody_set_useGravity_m1B1B22E093F9DC92D7BEEBBE6B02642B3B6C4389(L_80, (bool)0, NULL);
		__this->___isStretching = (bool)0;
		__this->___isRotating = (bool)0;
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_81 = V_2;
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF** L_82 = (Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF**)(&__this->___grabbedObjectRenderer);
		Color_tD001788D726C3A7F1379BEED0260B9591F440C1F L_83 = __this->___highlightColor;
		GrabbableMobile_HighlightRenderer_mC1437A516901709E2275474DAF90D9E243FD4B04(__this, L_81, L_82, L_83, NULL);
	}
